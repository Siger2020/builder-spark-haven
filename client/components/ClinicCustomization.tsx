      ...
      <Tabs defaultValue="colors" className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleThemeChange({ clinicName: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleThemeChange({ tagline: e.target.value })
                  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {fontOptions.map((font) => (
                  <Card
                    ...
                    onClick={() =>
                      handleThemeChange({ fontFamily: font.value })
                    }
                  >
                    <CardContent className="p-4">
                      ...
                      <p className="text-lg" style={{ fontFamily: font.value }}>
                        {font.preview}
                      </p>
                    </CardContent>
                  </Card>
        ...
        <TabsContent value="preview" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div
                className={`mx-auto border-2 border-gray-200 rounded-lg overflow-hidden ${getPreviewClasses()}`}
              >
                <div

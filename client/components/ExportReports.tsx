...
export function ExportReports({ isOpen, onClose }: ExportReportsProps) {
  ...
  const getAvailableFormats = () => {
    ...
    const selectedReportObjects = reportTypes.filter((r) =>
      selectedReports.includes(r.id),
    );
    return selectedReportObjects.reduce(
      (common, report) => {
        ...
        {isExporting ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 font-arabic">
              يرجى الانتظار، قد تستغرق هذه العملية بضع دقائق
            </p>
            <div className="mt-4">
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-bold font-arabic mb-2">
              تم تصدير التقارير بنجاح!
            </h3>
            <p className="text-gray-600 font-arabic">
              تم حفظ التقارير في مجلد التحميلات
            </p>
          </div>
        ) : (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-bold font-arabic mb-4">
                اختر أنواع التقارير
              </h3>
                  ...
                  <ul className="space-y-1 text-sm">
                    ...
                    {dateRange.from && dateRange.to && (
                      <li className="font-arabic">
                        ...
                        {new Date(dateRange.from).toLocaleDateString("ar-SA")}{" "}

...
const predefinedResponses: Record<string, string> = {
  'حجز موعد': 'يمكنك حجز موعد بسهولة من خلال النقر على زر "احجز موعداً الآن" في الصفحة الرئيسية، أو عبر الاتصال بنا على 777-123-456. نحن متاحون من السبت إلى الخميس من 9 صباحاً حتى 9 مساءً.',
  'حالة طارئة': 'في حالات الطوارئ، يرجى الاتصال فوراً على الرقم 777-123-456. نحن نوفر خدمة الطوارئ على مدار الساعة لضمان حصولك على الرعاية اللازمة.',
  'خدماتنا': 'نقدم خدمات شاملة تشمل: تنظيف الأسنان، حشوات تجميلية، تقويم الأسنان، زراعة الأسنان، تبييض الأسنان، علاج جذور الأسنان، وتركيبات الأسنان. جميع خدماتنا تتم بأحدث التقنيات الطبية.',
  'ساعات العمل': 'ساعات عملنا: من السبت إلى الخميس: 9:00 صباحاً - 9:00 مساءً، يوم الجمعة: 2:00 ظهراً - 9:00 مساءً. كما نوفر خدمة الطوارئ على مدار الساعة.',
  'أسعار': 'أسعارنا تنافسية ومناسبة. نقبل معظم بطاقات التأمين الطبي. للاستفسار عن أسعار خدمة معينة، يرجى الاتصال بنا أو زيارة العيادة للحصول على استشارة مجانية.',
  'موقع': 'تقع عيادتنا في موقع مميز وسهل الوصول. يمكنكم زيارتنا أو الاتصال بنا لمعرفة الاتجاهات الدقيقة.',
  'دكتور': 'الدكتور كمال الملصي هو طبيب أسنان معتمد مع أكثر من 15 سنة من الخبرة في مجال طب الأسنان. متخصص في جميع مجالات طب الأسنان وحاصل على عدة شهادات مهنية.'
};
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      content: 'مرحباً بك في عيادة الدكتور كمال الملصي! 👋\nكيف يمكنني مساعدتك اليوم؟',
      timestamp: new Date()
    }
  ]);
      ...
      <Card className={`transition-all duration-300 shadow-2xl ${
        ...
        <CardHeader className="flex flex-row items-center justify-between p-4 bg-dental-primary text-white rounded-t-lg">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-sm font-arabic">مساعد العيادة الذكي</CardTitle>
                ...
                >
                  ...
                  >
                    <div className="flex items-start gap-2">
                      {message.type === 'bot' && <Bot className="h-4 w-4 mt-1 text-dental-primary" />}
                      {message.type === 'user' && <User className="h-4 w-4 mt-1" />}
                      <div>
                        <p className="text-sm font-arabic whitespace-pre-line">{message.content}</p>
